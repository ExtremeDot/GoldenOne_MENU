...
green "-------------- Initial Setup"
echo "1) System Status & Show Status"										echo "5) Firewall [DIS/EN]ABLER "
echo "2) Install XAN MOD KERNEL"											blue "6) Input OLD and NEW Server Information "
echo "3) Install JINWYP Kernel Tuner Script"								blue "7) Input Domain and Email Address "
echo "4) Install Certificate USING ACME "									echo "8) IPV6 [DIS/EN]ABLER"
echo "5) Firewall [DIS/EN]ABLER "											echo "9) Edit SSH config file"
